                ...
                <div className="grid md:grid-cols-3 gap-8 mb-8">
                    ...
                    <div>
                        <ul className="space-y-2 mt-2">
                            <li> <a href="/terms" className="text-white">
                                टर्म्स ऑफ़ सर्विस
                                </a>
                            </li>
                            <li> <a href="/privacy"  className="text-white">
                                प्राइवेसी पॉलिसी
                                </a>
                            </li>
                            <li> <a href="/disclaimer" className="text-white"> 
                                डिस्क्लेमर
                                </a>
                            </li>
                            <li> <a href="/policy"  className="text-white">
                                कंटेन्ट पॉलिसी
                                </a>
                            </li>
                        </ul>
                    ...
                    <div>
                        ...
                        <div className="flex gap-3">
                            ...
                            <a href="https://www.instagram.com/__charchagram__/" target="_blank" rel="noopener noreferrer" className="hover:text-gray-300 transition-colors">
                                <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
